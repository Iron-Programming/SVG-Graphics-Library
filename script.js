var SVGCANVAS, color, stroke, strokeWeight, path, ellipse, rect, line, triangle, cPath, img, vertex, beginPath, endPath, cBezierVertex, qBezierVertex, bezier, scBezierVertex, sqBezierVertex, animate, text, ROTATE = 0, TRANSLATEX = 0, TRANSLATEY = 0, SCALEX = 1, SCALEY = 1, rotate, scale, translate, resetMatrix, rotPosX = 0, rotPosY = 0, draw, drawSpeed = 50, frameRate;
    ...
    var Canvas = (function() {
        ...
        Canvas.prototype.draw = function(func, id) {
            var elements;
